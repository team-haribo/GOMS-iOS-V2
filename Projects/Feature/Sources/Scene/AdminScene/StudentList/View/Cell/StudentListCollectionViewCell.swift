...
final class StudentListCollectionViewCell: UICollectionViewCell {
    // MARK: Propertices
    static let identifier = "StudentListCell"
    ...
    private func addView() {
        [profileImageView, nameLabel, studentInformationLabel, divLine, editButton, bottomView].forEach { contentView.addSubview($0)}
    }
