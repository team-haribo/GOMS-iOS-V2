...
public class ProfileChangRePasswordViewController: BaseViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func setLayout() {
        ...
        passwordTextField.snp.makeConstraints {
            ...
            textFieldBottomConstraint = $0.bottom.equalToSuperview().inset(395).constraint
            $0.leading.equalToSuperview().inset(20)
        ...
        doneButton.snp.makeConstraints {
            ...
            doneButtonBottomConstraint = $0.bottom.equalToSuperview().inset(138).constraint
            $0.height.equalTo(48)
            $0.width.equalTo(335)
            $0.leading.equalToSuperview().inset(20)
            $0.trailing.equalToSuperview().inset(20)
    ...
    override func keyboardWillShow(_ notification: Notification) {
        ...
        UIView.animate(withDuration: 0.3) { [weak self] in
            ...
            self.textFieldBottomConstraint?.update(inset: keyboardHeight + 174)
    ...
    override func keyboardWillHide(_ notification: Notification) {
        UIView.animate(withDuration: 0.3) { [weak self] in
            guard let self = self else { return }
            self.doneButtonBottomConstraint?.update(inset: 138)
            self.textFieldBottomConstraint?.update(inset: 395)
